...
export default function Dashboard({user}:{user:{name:string;email:string;role:string;companyName:string;isDemo:boolean;sessionExpiresAt:string}}) {
  ...
  // A carga é assíncrona; o efeito apenas inicia a sincronização com as APIs.
  ...
  useEffect(() => {
    ...
    // O tema salvo só existe no navegador, depois da primeira renderização.
    // eslint-disable-next-line react-hooks/set-state-in-effect
